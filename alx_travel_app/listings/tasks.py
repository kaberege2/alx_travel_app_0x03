...
def send_payment_confirmation_email(user_email, payment_id):
    ...
    message = (
        ...
        f"Your payment for booking {payment.booking.id} has been successfully processed.\n"
        f"Amount Paid: {payment.amount} {payment.booking.currency if hasattr(payment.booking, 'currency') else 'USD'}\n"
